...
for line in sys.stdin:
    ...
    pickup_datetime = key.strip('"') #if key both pickup and dropoff time
    
    month = datetime.strptime(pickup_datetime, '%m/%d/%Y %H:%M:%S').strftime('%m')
    day = datetime.strptime(pickup_datetime, '%m/%d/%Y %H:%M:%S').strftime('%d')
